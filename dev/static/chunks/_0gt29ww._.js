...
;
;
const navColleges = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$site$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["colleges"].map((c)=>({
        label: c.name,
...
function SiteHeader() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SiteHeader.useEffect": ()=>{
            const handler = {
                "SiteHeader.useEffect.handler": ()=>setScrolled(window.scrollY > 10)
            }["SiteHeader.useEffect.handler"];
            window.addEventListener("scroll", handler, {
                passive: true
            });
            return ({
                "SiteHeader.useEffect": ()=>window.removeEventListener("scroll", handler)
            })["SiteHeader.useEffect"];
        }
    }["SiteHeader.useEffect"], []);
...
_s1(SiteHeader, "/d36SEfuAELSZpeW6q7Mb5gAVBA=");
_c1 = SiteHeader;
var _c, _c1;
...
//# sourceMappingURL=_0gt29ww._.js.map